...
<script src="<?php echo plugins_url(); ?>/download-manager/assets/js/raphael.js"></script>
<script src="<?php echo plugins_url(); ?>/download-manager/assets/js/popup.js"></script>
<script src="<?php echo plugins_url(); ?>/download-manager/assets/js/analytics.js"></script>
<?php
global $wpdb;
